                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Please Fill in Details Accordingly</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        @if ($errors->any())
                        ...
                        <form role="form" method="post" action="{{url('add-drug')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Dosage Description</label>
                                    <textarea id="editor1" name="editor1" rows="10" cols="80" placeholder="Describe Drug Dosage"></textarea>
                                </div>
                                <div class="form-group">
                                    <label >Drug Image</label>
                                    <input type="file" name="drug_image" required>

                                    <p class="help-block">Please upload cover image of drug here</p>
                                </div>
...
<script src="{{url('view-assets')}}/bower_components/ckeditor/ckeditor.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{url('view-assets')}}/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<script>
    $(function () {
