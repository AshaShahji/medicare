...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{url('view-assets')}}/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{url('admin-home')}}">Medicare Admin</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to Manage your site users</p>

        <form action="{{url('verify-admin')}}" method="post">
            {{csrf_field()}}
...
<!-- iCheck -->
<script src="{{url('view-assets')}}/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
